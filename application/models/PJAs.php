...
class PJAs extends MY_Model
{
	...
	function __construct()
	{
		...
		$this->form = array(
			...
			array(
				'name' => '1a_isneed',
				'options' => array(
					array('value' => '0', 'text' => 'Need'),
					array('value' => '1', 'text' => 'Not Need')
				),
	...
	function excel ($uuid)
	{
		...
		$cellMap = array(
			...
			'F73' => $val['10a_isya'] === '1' ? '✓' : '',
			'G73' => $val['10a_isya'] === '0' ? '✓' : '',
			'H73' => $val['10a_isneed'] === '1' ? '✓' : '',
			'I73' => $val['10a_note'],

			'F74' => $val['10b_isya'] === '1' ? '✓' : '',
			'G74' => $val['10b_isya'] === '0' ? '✓' : '',
			'H74' => $val['10b_isneed'] === '1' ? '✓' : '',
			'I74' => $val['10b_note'],

			'F75' => $val['10c_isya'] === '1' ? '✓' : '',
			'G75' => $val['10c_isya'] === '0' ? '✓' : '',
			'H75' => $val['10c_isneed'] === '1' ? '✓' : '',
			'I75' => $val['10c_note'],

			'F76' => $val['10d_isya'] === '1' ? '✓' : '',
			'G76' => $val['10d_isya'] === '0' ? '✓' : '',
			'H76' => $val['10d_isneed'] === '1' ? '✓' : '',
			'I76' => $val['10d_note'],

			'F77' => $val['10e_isya'] === '1' ? '✓' : '',
			'G77' => $val['10e_isya'] === '0' ? '✓' : '',
			'H77' => $val['10e_isneed'] === '1' ? '✓' : '',
			'I77' => $val['10e_note'],

			'F78' => $val['10f_isya'] === '1' ? '✓' : '',
			'G78' => $val['10f_isya'] === '0' ? '✓' : '',
			'H78' => $val['10f_isneed'] === '1' ? '✓' : '',
			'I78' => $val['10f_note'],

			'F80' => $val['11a_isya'] === '1' ? '✓' : '',
			'G80' => $val['11a_isya'] === '0' ? '✓' : '',
			'H80' => $val['11a_isneed'] === '1' ? '✓' : '',
			'I80' => $val['11a_note'],

			'F81' => $val['11b_isya'] === '1' ? '✓' : '',
			'G81' => $val['11b_isya'] === '0' ? '✓' : '',
			'H81' => $val['11b_isneed'] === '1' ? '✓' : '',
			'I81' => $val['11b_note'],

			'F83' => $val['12a_isya'] === '1' ? '✓' : '',
			'G83' => $val['12a_isya'] === '0' ? '✓' : '',
			'H83' => $val['12a_isneed'] === '1' ? '✓' : '',
			'I83' => $val['12a_note'],

			'F84' => $val['12b_isya'] === '1' ? '✓' : '',
			'G84' => $val['12b_isya'] === '0' ? '✓' : '',
			'H84' => $val['12b_isneed'] === '1' ? '✓' : '',
			'I84' => $val['12b_note'],

			'F85' => $val['12c_isya'] === '1' ? '✓' : '',
			'G85' => $val['12c_isya'] === '0' ? '✓' : '',
			'H85' => $val['12c_isneed'] === '1' ? '✓' : '',
			'I85' => $val['12c_note'],

			'F86' => $val['12d_isya'] === '1' ? '✓' : '',
			'G86' => $val['12d_isya'] === '0' ? '✓' : '',
			'H86' => $val['12d_isneed'] === '1' ? '✓' : '',
			'I86' => $val['12d_note'],
		);
