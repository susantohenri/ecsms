  ...
  function up () {
    ...
    $this->db->query("
      CREATE TABLE `fe` (
        ...
        `elemen_1_nilai_awal` INT(11) NOT NULL,
        `elemen_1_bobot` INT(11) NOT NULL,
        `elemen_1_nilai_akhir` INT(11) NOT NULL,
        `elemen_2_nilai_awal` INT(11) NOT NULL,
        `elemen_2_bobot` INT(11) NOT NULL,
        `elemen_2_nilai_akhir` INT(11) NOT NULL,
        `elemen_3_nilai_awal` INT(11) NOT NULL,
        `elemen_3_bobot` INT(11) NOT NULL,
        `elemen_3_nilai_akhir` INT(11) NOT NULL,
        `elemen_4_nilai_awal` INT(11) NOT NULL,
        `elemen_4_bobot` INT(11) NOT NULL,
        `elemen_4_nilai_akhir` INT(11) NOT NULL,
