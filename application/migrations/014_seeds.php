...
class Migration_seeds extends CI_Migration
{
  ...
  function up()
  {
    ...
    foreach (array('User', 'HSSE', 'MPS', 'Vendor', 'Role', 'Permission', 'Menu', 'Project', 'PesertaProject', 'HSE', 'PJA', 'WIP', 'LaporanBulanan', 'KPI', 'Email', 'Template'/*additionalEntity*/) as $entity) {
